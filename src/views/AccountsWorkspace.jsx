...
import { TrendingUp, TrendingDown, Clock, ShieldAlert, Sparkles, RefreshCw, BarChart3, LineChart, Table } from 'lucide-react';
import { toast } from 'react-hot-toast';
import { ResponsiveContainer, LineChart as ReLineChart, Line, XAxis, YAxis, Tooltip, Legend, BarChart, Bar, CartesianGrid, ReferenceLine } from 'recharts';
...
export function AccountsWorkspace() {
  ...
  useEffect(() => {
    if (activeTab === 'insights' && aiInsightsList.length === 0) {
      loadAIInsights();
    }
  }, [activeTab]);
  ...
  return (
    <div className="space-y-6 font-body">
      ...
      {/* Workspace Router */}
      <div>
        {activeTab === 'financials' && <FinancialOverview />}
        {activeTab === 'charts' && <ChartsSection />}
        {activeTab === 'insights' && <AIFinancialInsights />}
