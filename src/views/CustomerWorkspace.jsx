...
import { Search, UserPlus, ShoppingCart, ListCollapse, Coins, Trash2, CheckCircle2, AlertTriangle, Send } from 'lucide-react';
...
export function CustomerWorkspace() {
    ...
    const handleSaveBill = async () => {
      ...
      if (success) {
        ...
        setBillModal({
          ...
          billId: `B${Math.floor(Math.random() * 900) + 100}`
        });
  ...
  return (
    <div className="space-y-6 font-body">
      ...
      {/* Render sub view */}
      <div>
        {activeTab === 'new-bill' && <NewBillingTerminal />}
        {activeTab === 'register' && <CustomerRegistration />}
        {activeTab === 'products' && <ProductManagement />}
        {activeTab === 'dues' && <DuesAndPayments />}
