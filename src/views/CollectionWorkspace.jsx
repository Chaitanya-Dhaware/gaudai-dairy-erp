...
import { Search, Plus, UserPlus, FileInput, IndianRupee, BarChart2, ShieldAlert } from 'lucide-react';
...
export function CollectionWorkspace() {
  ...
  const MilkCollectionEntry = () => {
    ...
    // Auto load farmer's milk preference when selected
    useEffect(() => {
      const f = farmers.find(farm => farm.farmer_id === selectedFarmerId);
  ...
  return (
    <div className="space-y-6 font-body">
      ...
      {/* Render sub tab */}
      <div>
        {activeTab === 'farmer-reg' && <FarmerRegistration />}
        {activeTab === 'milk-entry' && <MilkCollectionEntry />}
